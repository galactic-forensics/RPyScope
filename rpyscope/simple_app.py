...
initial_directory = '/home/pi/Desktop'
initial_file = 'A1'
...
while True:
    ...
    fname = tk.filedialog.asksaveasfilename(title="Where do you want to save the next Picture?", \
                                            filetypes = [('Portable Network Graphics','*.png')], \
                                            initialdir = initial_directory, \
                                            initialfile = initial_file)#initial_directory)
    root.destroy()
